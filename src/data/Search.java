			...
			if (rs != null) {
				while (rs.next()) {
					result += "<tr> <td><h4>" + rs.getString("name")
							+ "</h4></td><td style=\"text-align:right\"><form method=\"get\" action=\"Menu\"><input type=\"hidden\"name=\"id\" value=\""
							+ rs.getString("id")
							+ "\"><input type=\"submit\" class=\"btn btn-primary green\" value=\"Order Now!\"></form></td></tr>";
